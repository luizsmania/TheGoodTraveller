...
* Deployment was made possible by GitHub
    + Initiated a repository in git : https://github.com/luizsmania/TheGoodTraveller
...
* Cloning of Project was made possible by GitHub
    + Go to Git Hub
    + Go to The Good Traveller repository https://github.com/luizsmania/TheGoodTraveller
 ...
 * Images obtained via bing image search with the free to use, modify and use license requirement on. Majority of pictures come from Pexels.Com website

 ![Image Obtained](https://i.imgur.com/qKD89Tz.png)


 * Videos Obtained from YouTube. 
 + Austria . https://youtu.be/FsjHqvpTRag
 + Brazil . https://youtu.be/rPJ0q1j8n6U
 + Cuba . https://youtu.be/5uv5FVJb-iA
 + Egypt . https://youtu.be/6OhdZ9TurMs
 + Jamaica . https://youtu.be/k4MWgNsxd_c
